...
#define DEVMAPPER_CONTROL_FILE MBPATH_DEV"/device-mapper"
                                 ...
                                 const char *real_blk_name, char *crypto_blk_name, const char *name)
{
    ...
    snprintf(crypto_blk_name, MAXPATHLEN, MBPATH_DEV"/block/dm-%u", minor);
    retval = mknod(crypto_blk_name, S_IFBLK | 0600, io->dev);
